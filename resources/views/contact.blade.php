...
<html lang="en">
<head>
    <link rel="icon" href="{{ asset('uploads/favicon-rigid-boxes.png') }}" type="image/png">
                ...
                <div class="contact-grid">
                    <div class="contact-intro">
                        ...
                        <div class="contact-details">
                            <a href="tel:{{ $siteSettings['company_phone'] ?? '1800-518-8441' }}" class="detail-item"><img src="{{ asset('images/contact-phone-icon.png') }}" alt="Phone Icon" class="detail-icon" loading="lazy"><span>{{ $siteSettings['company_phone'] ?? '1800-518-8441' }}</span></a>
                            <a href="mailto:{{ $siteSettings['company_email'] ?? 'example@gmail.com' }}" class="detail-item"><img src="{{ asset('images/envelope 2.png') }}" alt="Envelope Icon" class="detail-icon" loading="lazy"><span>{{ $siteSettings['company_email'] ?? 'example@gmail.com' }}</span></a>
                            <div class="detail-item"><img src="{{ asset('images/calendar 1.png') }}" alt="Calendar Icon" class="detail-icon" loading="lazy"><span>Monday - Sunday</span></div>
                            @php
                            ...
                            @endphp
                            <address class="detail-item contact-address"><img src="{{ asset('images/marker 1.png') }}" alt="Location Marker Icon" class="detail-icon" loading="lazy"><span class="address-desktop">{!! $rawAddress !!}</span><span class="address-mobile">{!! $mobileAddress !!}</span></address>
                        </div>
                    </div>
                    @if(session('success'))
