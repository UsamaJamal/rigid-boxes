    ...
    <div class="cta-container">
        <div class="cta-banner">
            <div class="cta-text-card">
                <img src="{{ asset('uploads/cta-ellipse-1.png') }}" alt="CTA background ellipse left" class="cta-ellipse cta-ellipse-1">
                <img src="{{ asset('uploads/cta-ellipse-2.png') }}" alt="CTA background ellipse right" class="cta-ellipse cta-ellipse-2">
